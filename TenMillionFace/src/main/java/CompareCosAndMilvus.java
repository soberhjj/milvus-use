...
public class CompareCosAndMilvus {
    public static void main(String[] args) throws Exception {
        ...
        String nprobe_number = "256,512,1024";
        for (String s : nprobe_number.split(",")) {
            nprobes.add(Integer.parseInt(s));
        }
        BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\Administrator\\Desktop\\压测和准确率\\准确率结果.txt"));
        for (int i = 1; i < 3; i++) {
            for (int nprobe : nprobes) {
                ...
                ois1.close();
                ObjectInputStream ois2 = new ObjectInputStream(new FileInputStream(String.format("C:\\Users\\Administrator\\Desktop\\压测和准确率\\accuracy_res\\ifs1024\\nlist1024\\%d-%d", nprobe, i)));
