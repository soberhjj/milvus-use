            ...
            for (int j = 0; j < 5; j++) {
                ...
                for (List<Float> list : searchVectors) {
                    ...
                    SearchParam searchParam =
                            new SearchParam.Builder("FACE_1599613749000_new")
                    ...
                    List<List<Float>> resVectors = client.getEntityByID("FACE_1599613749000_new", ids).getFloatVectors();
                ...
                ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(String.format("C:\\Users\\Administrator\\Desktop\\milvus后期测试20210421\\准确性比较\\100w_addnewface\\milvus_new\\%d-%d", i, j)));
