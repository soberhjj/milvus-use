...
public class CompareCosAndMilvus {
    public static void main(String[] args) throws Exception {
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\Administrator\\Desktop\\milvus后期测试20210421\\准确性比较\\suotian\\测试结果.txt"));
        for (int i = 0; i < 5; i++) {
            for (int nprobe : nprobes) {
                ObjectInputStream ois1 = new ObjectInputStream(new FileInputStream("C:\\Users\\Administrator\\Desktop\\milvus后期测试20210421\\准确性比较\\suotian\\cos\\"+i));
                LinkedList<float[]> cosRes = (LinkedList<float[]>) ois1.readObject();
                System.out.println(cosRes.size());
                ois1.close();

                ObjectInputStream ois2 = new ObjectInputStream(new FileInputStream(String.format("C:\\Users\\Administrator\\Desktop\\milvus后期测试20210421\\准确性比较\\suotian\\milvus\\%d-%d", nprobe, i)));
